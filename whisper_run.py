...
segs, info = m.transcribe(wav_path, beam_size=1, language=language, vad_filter=True,
    vad_parameters=dict(min_silence_duration_ms=500, speech_pad_ms=400),
    no_speech_threshold=0.7, log_prob_threshold=-1.0, condition_on_previous_text=False)
